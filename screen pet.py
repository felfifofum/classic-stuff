#run mouse over to make him blush
#double click him to stick tongue out and cross eyes when double clicked
#stroke to make happy again
...
c.bind('<Motion>', show_happy)#links moving mouse pointer and happy face
c.bind('<Leave>', hide_happy)
c.bind('<Double-1>', cheeky) #change to wink to wink instead

c.happy_level=10  #increase this so not sad all the time
c.eyes_crossed=False
c.tongue_out=False

root.after(1000,blink)
root.after(5000, sad)
#root.after(5000, change_color) #uncomment to make him change colour
root.mainloop()
